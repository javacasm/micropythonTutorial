...
# set strip color
def set_color(r, g, b):
  print('set_color '+str(r)+','+str(g)+','+str(b))
  for i in range(n):
    np[i] = (r, g, b)
    np.write()
...
def fade_in_out(color, wait):
  print('fade_in_out '+str(color)+' ,'+str(wait))
...
def bounce(r, g, b, wait):
  print('bounce '+str(r)+','+str(g)+','+str(b)+','+str(wait))
  for i in range(4 * n):
    for j in range(n):
      np[j] = (r, g, b)
    if (i // n) % 2 == 0:
...
def cycle(r, g, b, wait):
  print('cycle '+str(r)+','+str(g)+','+str(b)+','+str(wait))
  for i in range(4 * n):
    for j in range(n):
      np[j] = (0, 0, 0)
    np[i % n] = (r, g, b)
